...
export async function POST(request: Request) {
  try {
    ...
    const instructions = [
      ...
      'Don\'t repeat the phrase/content back to the user (unless they ask you to for practice), be as concise as possible.',
      ...
      'Tell them whether their pronunciation is correct, rate it from 1 to 10 and let the user know what was good and what was bad:',
      'Point out specific words or syllables that were off (but don\'t be too picky, understand that there\'s noise in the audio) and give a concise, friendly critique with the correct pronunciation if needed.',
      ...
      'THE HIGHER THE RATING, THE FEEDBACK SHOULD BE MORE CONCISE BUT SPECIFIC.',
