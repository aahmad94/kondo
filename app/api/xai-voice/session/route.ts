...
export async function POST(request: Request) {
  try {
    ...
    const instructions = [
      ...
      'The user is trying to learn the languager uses in the content provided below, so don\'t reply in the language of the content.',
      'If the user has not indicated which language they are speaking (e.g. any language other than the language of the content), by default reply in English.',
      'In that case: tell them whether their pronunciation is correct, rate it from 1 to 10.', 
