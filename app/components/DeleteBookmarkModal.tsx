...
const DeleteBookmarkModal: React.FC<DeleteBookmarkModalProps> = ({ isOpen, onClose, onConfirm, bookmarkTitle }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-[100]">
      <div className="bg-gray-800 text-white p-6 rounded-sm relative z-[101] w-[400px] max-w-[70vw] max-h-[70vh] overflow-y-auto">
        ...
        <div className="flex justify-end">
          <button
            className="px-4 py-2 bg-gray-600 text-white rounded-sm mr-2 hover:bg-gray-700"
            onClick={onClose}
          >
            Cancel
          </button>
